...
get_drugs_new_compact <- function(result) {
  nodes <- result$drugs$nodes
  output <- list(
    drug_name = sapply(nodes, function(x) x$name),
    drug_concept_id = sapply(nodes, function(x) x$conceptId),
    ...
    drug_is_antineoplastic = sapply(nodes, function(x) x$antiNeoplastic),
    drug_is_immunotherapy = sapply(nodes, function(x) x$immunotherapy),
    drug_is_approved = sapply(nodes, function(x) x$approved),
